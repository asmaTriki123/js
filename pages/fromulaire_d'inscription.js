...
// permet de navigée entre les pages
...
export default function Login() {
    ...
    {
      if(!emaill || !nom || !prenom || !Num_tel ||!Adr || !MPass){
        setError(true)
        return false
      }
        let item = {nom , prenom , emaill , Adr , MPass , Num_tel}
        console.warn(item)
        if(!emaill || !nom || !prenom || !Num_tel ||!Adr || !MPass){
          setError(true)
          return false
  ...
  return (
    <form >
     ...
     {/*taswira ili 3la jnab f inscription admin*/}
     {/*3ibra div wa ila aka linear layout f endroid bloc 3ibara*/ }
        <Grid
          item
          lg={7}
          sm={5}
          ...
          <Card sx={{ width: "100%", height: "100%" }}>
            <Box sx={{ mx: 3, height: 530 }}>
              ...
              <Box component="form" noValidate sx={{ mt: 1 }} id="login-form">
                ...
                />
                {error && !emaill &&<span className="text-sm text-red-600 grid grid-cols-2 " >&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>champ obligatoire*</b></span>}

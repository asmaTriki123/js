...
function Client() {
    ...
    // Nous utilisons le useEffectcrochet pour appeler des fonctions avec des effets secondaires dans nos composants.
    // t3awthli deux méthode kanou ysta3mlohom 9abl
    useEffect(async() =>{
        getClient();
    } , [])
                    ...
                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                        <div className="rounded-t mb-0 px-4 py-3 border-0">
                            <div className="lg:flex items-center">
                                {/* hatha la barre de recherche f espace de client*/}
                                <div className="relative w-full px-4 max-w-full flex">
                                    ...
                                    <div className="flex gap-x-3 rounded-tr-xl rounded-br-xl  border border-gray-100 p-2  item-center">
                                       {/*e.target.value yo9sdo bih test ili ma7tout f search input on change déclancher ki ysir un évemenet de font entré ou siaise de donner*/ }
